...
if __name__ == '__main__':
    ...
    for day_number in range(total_days):
        ...
        if possible_file.exists():
            logger.warning('This date ({}) has already been processed. The files will be reprocessed and '
        ...
        if 0 in tempList:
            ...
            if SAVE_ALL_SNODAS_PARAMS.upper() == 'FALSE' or SAVE_ALL_SNODAS_PARAMS.upper() == 'TRUE':
                ...
                # TODO smalers 2021-06-21 list all the files.
                logger.info("Folder: {}".format(set_format_path))
                for file in os.listdir(set_format_path):
                ...
                for file in os.listdir(set_format_path):
                    if current_date in file:
                        SNODAS_utilities.convert_snodas_bil_to_tif(file, set_format_path)
