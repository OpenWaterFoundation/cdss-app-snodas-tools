...
# - location is software.openwaterfoundation.org/cdss-app-snodas-tools-doc-user

# Set --dryrun to test before actually doing
dryrun=""
#dryrun="--dryrun"
s3Folder="s3://software.openwaterfoundation.org/cdss-app-snodas-tools-doc-user"
