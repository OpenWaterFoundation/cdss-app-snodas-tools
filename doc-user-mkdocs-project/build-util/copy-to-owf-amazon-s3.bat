...
rem - location is software.openwaterfoundation.org/cdss-app-snodas-tools-doc-user

rem Set --dryrun to test before actually doing
set dryrun=""
rem dryrun="--dryrun"
set s3Folder="s3://software.openwaterfoundation.org/cdss-app-snodas-tools-doc-user"
